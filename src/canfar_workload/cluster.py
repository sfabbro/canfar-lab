...
lifecycle is a single library in ``canfar_workload``.
"""
...
from canfar_workload.workers import build_worker_env, destroy_all_workers, destroy_worker
...
def stop_cluster(
    *,
    ...
    if not state:
        ...
        from canfar_workload.autoscaler import destroy_autoscaler_workers
